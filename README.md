...
*   [zhiyu1998/Computer-Science-Learn-Notes](https://github.com/zhiyu1998/Computer-Science-Learn-Notes) - CS（Computer Science）生涯：读书笔记，集成Java知识体系！（Java基础、JVM、JUC、Spring系列、面试八股文、力扣刷题笔记，数据结构和算法、SpringBoot整合其他框架等）
...
*   [mulingyuer/Typecho\_Theme\_JJ](https://github.com/mulingyuer/Typecho_Theme_JJ) - Typecho主题-《高仿掘金》第一版webpack重构完成，请尽情体验使用（补充了dist目录）
...
*   [gz-yami/mall4m](https://github.com/gz-yami/mall4m) - 微信小程序商城
...
*   [go-cqhttp/node](https://github.com/go-cqhttp/node) - 基于 go-cqhttp 和 nodejs 的 qq 机器人
...
*   [xoraus/CrackingTheSQLInterview](https://github.com/xoraus/CrackingTheSQLInterview) - Compilation of SQL interview Questions
...
*   [yoonje/developer-interview-questions-and-answers](https://github.com/yoonje/developer-interview-questions-and-answers) - 개발자 인터뷰 팁 그리고 질문 모음과 답변
...
*   [youthlql/JavaYouth](https://github.com/youthlql/JavaYouth) - 主要是Java技术栈的文章，涉及到了源码、原理，面试等知识。如AQS，JVM，rpc源码，Spring源码，计网，os等等。
...
*   [aiboboxx/clashfree](https://github.com/aiboboxx/clashfree) - clash科学上网、clash翻墙、clash免费节点、clash订阅链接、clash教程
...
*   [Ealodi/pixild](https://github.com/Ealodi/pixild) -

*   [ccseer/Seer](https://github.com/ccseer/Seer) - Seer bug report
...
*   [Cnotech/flash-collector](https://github.com/Cnotech/flash-collector) - 小游戏收集器，支持小游戏一键下载、本地启动等功能
...
*   [yzbtdiy/alist\_batch\_add](https://github.com/yzbtdiy/alist_batch_add) - Alist批量添加阿里云资源
...
*   [ElainaMoe/MHYY-AutoCheckin](https://github.com/ElainaMoe/MHYY-AutoCheckin) - 米哈云游（云原神）自动签到脚本，让你每天都拿到15分钟~
...
*   [we0091234/Chinese\_license\_plate\_detection\_recognition](https://github.com/we0091234/Chinese_license_plate_detection_recognition) - yolov5 车牌检测   车牌识别   中文车牌识别 检测 支持12种中文车牌 支持双层车牌
...
*   [panghaibin/shuasr](https://github.com/panghaibin/shuasr) - Shanghai University Auto Selfreport Reminders - 上海某大学健康之路每日一报自动提醒系统 - 支持自动补报 - 可使用GitHub Actions - 可刷排名 - 自动阅读所有消息 - **NEW**可自动申请次日离校
...
*   [githublitao/api\_automation\_test](https://github.com/githublitao/api_automation_test) - 接口自动化测试平台，已停止维护，看心情改改
...
*   [flow2000/bing-wallpaper-api](https://github.com/flow2000/bing-wallpaper-api) - python搭建必应壁纸api
...
*   [autofelix/python-spiders](https://github.com/autofelix/python-spiders) - 🌈  Python网络爬虫实战：王者荣耀超清壁纸、抖音无水印视频、M3U8推流视频、正方系统、财务报表、美女帅哥图片、CSDN阅读量、淘宝、京东、网易云、B站、12306、抖音、笔趣阁、漫画小说音乐电影下载等
...
*   [Nemo2011/bilibili-api](https://github.com/Nemo2011/bilibili-api) - 哔哩哔哩常用API调用。支持视频、番剧、用户、频道、音频等功能。工具齐全。原储存库地址：https://github.com/MoyuScript/bilibili-api
...
*   [Chenjinyi/PHP-Images-Spider](https://github.com/Chenjinyi/PHP-Images-Spider) - 又一个PHP的图片爬虫，支持爬取Bilibili相簿，Artstation，Pixabay，Bing今日壁纸

*   [Chenjinyi/Image-spider](https://github.com/Chenjinyi/Image-spider) - Image Spider 图片爬虫，自动爬取Artstation Bcy BiliBili 哔哩哔哩 半次元网站的图片 PHP CURL库编写 自动爬取半次元热门作品 bcy-spider/artstation-spider
...
*   [DIYgod/QzoneAutoLike](https://github.com/DIYgod/QzoneAutoLike) - QQ空间自动点赞

*   [DIYgod/QzoneAutoReview](https://github.com/DIYgod/QzoneAutoReview) - QQ空间自动评论
...
*   [liyonghuan/daily-bing-wallpaper](https://github.com/liyonghuan/daily-bing-wallpaper) - :trophy::trophy:必应每日壁纸数据采集脚本、必应壁纸历史数据API和必应壁纸在线浏览。

*   [Mickeyto/phpVideos](https://github.com/Mickeyto/phpVideos) - php 写的视频下载工具，现已支持：Youku、Miaopai、腾讯、XVideos、Pornhub、91porn、微博酷燃、bilibili、今日头条、芒果TV
...
*   [fly-studio/douyin-downloader](https://github.com/fly-studio/douyin-downloader) - 抖音下载【无水印】的视频（2022-12-06更新，兼容android 11+）
...
*   [agamgn/ssm-Online\_Examination](https://github.com/agamgn/ssm-Online_Examination) - SSM实现的在线考试系统

*   [szvone/imgApiJava](https://github.com/szvone/imgApiJava) - 超简图床 Java版

*   [Hello-hao/Tbed](https://github.com/Hello-hao/Tbed) - Hellohao图床 | 图像托管 | 云相册，分享/水印、存储源分发、图像管理、前后端分离。https://tbed.hellohao.cn
...
*   [spring-projects/spring-data-keyvalue](https://github.com/spring-projects/spring-data-keyvalue) - Project to provide infrastructure to implement Spring Data repositories on top of key-value-based, in-memory data stores.
...
*   [spring-projects/spring-security-kerberos](https://github.com/spring-projects/spring-security-kerberos) -
...
*   [spring-projects/spring-integration-extensions](https://github.com/spring-projects/spring-integration-extensions) - The Spring Integration Extensions project provides extension components for Spring Integration
...
*   [spring-projects/spring-shell](https://github.com/spring-projects/spring-shell) - Spring based interactive shell
...
*   [jiujiujiujiujiuaia/bbs](https://github.com/jiujiujiujiujiuaia/bbs) - 基于spring boot的java论坛系统
...
*   [LianjiaTech/retrofit-spring-boot-starter](https://github.com/LianjiaTech/retrofit-spring-boot-starter) - A spring-boot starter for retrofit, supports rapid integration and feature enhancements.（适用于retrofit的spring-boot启动器，支持快速集成和功能增强）
...
*   [go-cqhttp/java](https://github.com/go-cqhttp/java) - 基于 go-cqhttp 和 java 的 qq 机器人
...
*   [imsyy/music](https://github.com/imsyy/music) - 無名の音乐站
...
*   [NotFound403/payment-spring-boot](https://github.com/NotFound403/payment-spring-boot) - 微信支付V3，微信优惠券，代金券、公众号支付、微信小程序支付、分账、支付分、商家券
...
*   [Asabeneh/30-Days-Of-HTML](https://github.com/Asabeneh/30-Days-Of-HTML) - A step by step guide to learn the concept of HTML, DOM tree, and web development in 30 days.
...
*   [QuestPDF/QuestPDF](https://github.com/QuestPDF/QuestPDF) - QuestPDF is an open-source modern .NET library for PDF document generation. Offering comprehensive layout engine powered by concise and discoverable C# Fluent API.
...
*   [cstack/db\_tutorial](https://github.com/cstack/db_tutorial) - Writing a sqlite clone from scratch in C
...
*   [Ascotbe/Kernelhub](https://github.com/Ascotbe/Kernelhub) - :palm\_tree:Kernel privilege escalation vulnerability collection, with compilation environment, demo GIF map, vulnerability details, executable file  (提权漏洞合集)
...
*   [citusdata/cstore\_fdw](https://github.com/citusdata/cstore_fdw) - Columnar storage extension for Postgres built as a foreign data wrapper. Check out https://github.com/citusdata/citus for a modernized columnar storage implementation built as a table access method.

*   [citusdata/pg\_cron](https://github.com/citusdata/pg_cron) - Run periodic jobs in PostgreSQL
...
*   [spring-projects/gradle-plugins](https://github.com/spring-projects/gradle-plugins) - Gradle plugins for use in building and publishing open-source Spring projects, e.g. Spring Framework, Spring Integration
