...
*   [xigua21/ComfyUI-](https://github.com/xigua21/ComfyUI-) - ComfyUI-Yolain-Workflows 一份非常全面的 ComfyUI 工作流合集，由 @yolain 整理并开源分享，包含文生图、图生图、背景去除、重绘/扩图、换脸、透明图层生成、重绘光影、三视图、电商产品主图等多种工作流。并且按基础、进阶、实战应用进行了分类
...
*   [stream-rec/stream-rec](https://github.com/stream-rec/stream-rec) - Automatic streaming record tool.  Live and bullet comments recorder. 虎牙/抖音/斗鱼/Twitch/PandaTV直播，弹幕自动录制
